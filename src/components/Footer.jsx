...
function Footer({ footerTranslate }) {
  return (
    <div
      style={{
      ...
      className={`bg-black z-40 scrollDiv left-0 bottom-0 absolute md:h-screen w-full box-border text-white py-20 px-5 flex flex-col justify-between`}
    >
      <div className="h-full w-full md:grid md:grid-cols-2">
        <div className="text-5xl lg:text-7xl xl:text-8xl font-bold leading-none tracking-tighter">
          <h1>EYE-</h1>
          <h1>OPENING</h1>
        </div>
        <div>
          <h1 className="text-5xl lg:text-7xl xl:text-8xl font-bold leading-none tracking-tighter">
            PRESENTATIONS
          </h1>
          ...
          <div className="flex justify-between pr-5 lg:pr-10 xl:pr-20">
            <div>
              <p>L:</p>
              <ul>
                {["202-1965 W 4th Ave", "Vancouver, Canada"].map((li, i) => (
                  <li key={i}>{li}</li>
                ))}
              </ul>

              <ul className="mt-5">
                {["30 Chukarina St", "Lviv, Ukraine"].map((li, i) => (
                  <li key={i}>{li}</li>
                ))}
              </ul>
            </div>
      ...
      <div className="md:grid md:grid-cols-2 mt-10">
        ...
        <div className="md:flex md:items-center md:justify-between text-gray-800 mt-5">
